        ...
        <div class="conversation-wrap col-lg-3">
            ...
            <div class="media conversation">
                ...
                <div class="media-body">
                    <h5 class="media-heading"><a href='messagePage (2).php'>User<a></h5>
                    <small>Hello</small>
                </div>
            </div>
            ...
            <div class="msg-wrap">
                ...
                <div class="media msg">
                    ...
                    <div class="media-body">
                        ...
                        <h5 class="media-heading">User</h5>
                        <small class="col-lg-10">User: "Some people close to Congress Party and close to the government had a #secret #meeting in a farmhouse in Maharashtra in which Anna Hazare send some representatives and they had a meeting in the discussed how to go about this all fast and how eventually this will end."</small>
                    </div>
                </div>
                <div class="media msg">
                    <a class="pull-left" href="#">
